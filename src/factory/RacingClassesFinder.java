...
public class RacingClassesFinder {
	...
	// private static String RACERS_PACKAGE = "game.racers";
	// private static String RACERS_PACKAGE_DIR = "src/game/racers";
	// private static String ARENAS_PACKAGE = "game.arenas";
	// private static String ARENAS_PACKAGE_DIR = "src/game/arenas";
